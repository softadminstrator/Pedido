...
public class Factura_in
{
	 ...
	 */
	public ArrayList<ArticulosFactura> listaArticulos;
	...
	public Factura_in() {
		listaArticulos=new ArrayList<ArticulosFactura>();
		isPagada=false;
	}
	...
	public ArrayList<ArticulosFactura> getListaArticulos() {
	...
	public Factura_in(long nFacturaIn, long nFacturaOut, long idCliente,
			String nombreCliente, String fecha, String cedulaUsuario,
			String observaciones, String latitud, String longitud, String hora,
			long valor, ArrayList<ArticulosFactura> listaArticulos,
	...
	public void cargarFacturaPrueba() {
		  ...
		  fecha="01/01/2014";
		  hora="24:13";
		  ArticulosFactura ar=new ArticulosFactura();
		  ar.setCantidad(10);
...
public void setProperty(int i, String data) {
		...
		switch(i)
		{
		case 0:  NFactura=Long.parseLong(data);break;
		...
		case 14:  totalFactura=Long.parseLong(data);break;
...
//		case 21:  rango=data;break;
	...
	public String getPropertyNameDatosFactura(int i) {
		switch(i)
		{
		case 0: return "NFactura";
		case 1: return "NCaja";
		case 2: return "Fecha";
		case 3: return "Hora";
		case 4: return "Base0";
...
//		case 21: return "Rango";
	...
	public void CalcularBasesIvas()
	{
		for (int i = 0; i < listaArticulos.size(); i++) {
			ArticulosFactura item=listaArticulos.get(i);			
	...
	{
		return totalFactura-ValorPagado-Devolucion;
	}
