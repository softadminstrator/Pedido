 ...
 *
 */
public class ArticulosPedido implements KvmSerializable
{
	/**
	 ...
	 * @param orden
	 */
	public ArticulosPedido(long idArticulo, long idPedido, double cantidad, String nombre, long valorUnitario, long valor, String codigo,
