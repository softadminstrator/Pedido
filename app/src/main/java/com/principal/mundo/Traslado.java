 ...
 *
 */
public class Traslado implements KvmSerializable
{
	 /**
	...
	public Traslado(int nCaja, long idCliente, String cedulaVendedor,
			ClsArtsFactura articulo, String observaciones, String latitud,
			String longitud, int idBodegaOrigen, int idBodegaDestino,
			String bodegaOrigen, String bodegaDestino) {
		super();
		NCaja = nCaja;
		IdCliente = idCliente;
	...
	public Object getProperty(int i) {
		...
		case 7: return IdBodegaOrigen;
		case 8: return IdBodegaDestino;
		case 9: return BodegaOrigen;
		case 10: return BodegaDestino;
		}
	...
	public void getPropertyInfo(int i, Hashtable arg1, PropertyInfo propertyInfo) {
	    ...
	    case 6:
	        ...
	        break;
	    case 7:
	        propertyInfo.name = "IdBodegaOrigen";
	        propertyInfo.type = PropertyInfo.INTEGER_CLASS;
	        break;
	    case 8:
	        propertyInfo.name = "IdBodegaDestino";
	        propertyInfo.type = PropertyInfo.INTEGER_CLASS;
	        break;
	    case 9:
	        propertyInfo.name = "BodegaOrigen";
	        propertyInfo.type = PropertyInfo.STRING_CLASS;
	        break;
	    case 10:
	        propertyInfo.name = "BodegaDestino";
	        propertyInfo.type = PropertyInfo.STRING_CLASS;
	        break;
	    default: break;
		 }
