 ...
 *
 */
public class ArticulosFactura implements KvmSerializable
{
	/**
	 ...
	 * @param orden
	 */
	public ArticulosFactura(long idArticulo, long idPedido, double cantidad, String nombre, long valorUnitario, long valor, String codigo,
			String unidad, long precio1, long precio2, long precio3, long ipoConsumo, long iva, double stock, long activo, long orden)
	{
