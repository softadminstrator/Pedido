 ...
 *
 */
public class Remision implements KvmSerializable
{
    /**
     ...
     */
    public ClsArtsRemision  Articulo;
    /**
    ...
    public Remision(long nCaja, long nFactura, long idCliente,
                   String cedulaVendedor, ClsArtsRemision articulo,
