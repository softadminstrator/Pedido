...
public class RemisionEnviarSys {
    ...
    public RemisionEnviarSys(String nCaja, String nRemision, String idCliente,
                            String cedulaVendedor, String observaciones, String latitud,
                            String longitud, String ventaCredito, String fecha, String fecha2,
                            String hora, String xmlArticulos) {
        super();
        NCaja = nCaja;
        NRemision = nRemision;
        IdCliente = idCliente;
    ...
    public void setListaArticulos(ArrayList<ArticulosRemision> listaArticulos )
    {
        ...
        for (int i = 0; i < listaArticulos.size(); i++) {
            ItemRemision art= new ItemRemision(listaArticulos.get(i));
            xml +="<Articulo>\n";
