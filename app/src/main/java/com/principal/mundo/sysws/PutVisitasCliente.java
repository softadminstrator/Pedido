 ...
 *
 */
public class PutVisitasCliente {
     ...
     */
    private static final String METHOD_NAME = "PutVisitasCliente";
    /**
     ...
     * @param ip
     */
    public PutVisitasCliente(String ip, String Webid)
    {
     ...
     * @return res
     */
    public String setVisitasCliente(String documento, String xmlVisitas){

        try {
            SoapObject request = new SoapObject(NAMESPACE, METHOD_NAME);

            PropertyInfo prPedido = new PropertyInfo();
            prPedido.name="documento";
            prPedido.type=String.class;
            prPedido.setValue(documento);
            request.addProperty(prPedido);

            PropertyInfo prArticulos = new PropertyInfo();
            prArticulos.name="xmlVisitas";
            prArticulos.type=String.class;
            prArticulos.setValue(xmlVisitas);
